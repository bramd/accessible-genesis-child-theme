...
/**
 * Genesis WPACC Latest Tweets widget class.
 *
 * @category WPACC
 * @package Widgets
 *
...
class WPACC_Latest_Tweets_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$this->WP_Widget( 'wpacc-latest-tweets', __( 'WPACC - Latest Tweets', 'genesis' ), $widget_ops, $control_ops );
 ...
 * Forked form genesis_tweet_linkify, removed the traget = _blank to make it accessible
 *
...
function wpacc_tweet_linkify( $text ) {
	...
	$text = preg_replace( "#(^|[\n ])([\w]+?://[\w]+[^ \"\n\r\t< ]*)#", '\\1<a href="\\2" title="externe site" rel="nofollow">\\2</a>', $text );
