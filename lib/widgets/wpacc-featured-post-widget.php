<?php
/**
 * Adds the Accessible Featured Post Widget.
 *
 * @category WPACC
 * @package  Widgets
...
/**
 * WPACC Featured Post widget class.
 *
 * @category WPACC
 * @package Widgets
 *
...
class WPACC_Featured_Post extends WP_Widget {
	...
	function __construct() {
		...
		$control_ops = array(
			'id_base' => 'wpacc-featured-post',
			'width'   => 505,
			'height'  => 350,
		);

		$this->WP_Widget( 'wpacc-featured-post', 'WPACC - Featured Posts', $widget_ops, $control_ops );
...
add_action( 'widgets_init', create_function( '', "register_widget('WPACC_Featured_Post');" ) );
